...
struct ContentListScreen: View {
    ...
    private var activeFilterColor: Color = Color(red: 27/255, green: 78/255, blue: 102/255)
            ...
            HStack {
                Button {
                    ...
                    VStack {
                        Text("Populares")
                            ...
                            .foregroundColor(activerFilter == .popular ? .black : .gray)
                        if activerFilter == .popular {
                            Rectangle()
                                .foregroundStyle(activeFilterColor)
                ...
                Button {
                    ...
                    VStack{
                        Text("Recentes")
                            .font(.system(size: 16, weight: .semibold))
                            .foregroundColor(activerFilter == .recents ? .black : .gray)
                        if activerFilter == .recents {
                            Rectangle()
                                .foregroundStyle(Color(red: 27/255, green: 78/255, blue: 102/255))
                                .frame(width: 188, height: 2)
                        }  else {
                            Rectangle()
                                .foregroundStyle(.white)
